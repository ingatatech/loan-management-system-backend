...
import Installmentpenaltyroutes from "./Installmentpenaltyroutes";
import Pricingroutes from "./Pricingroutes";
import systemAnalyticsRoutes from "./systemAnalyticsRoutes";
...
router.use("/organizations/:organizationId/notifications", notificationRoutes);
...
router.use("/organizations/:organizationId/installment-penalties", Installmentpenaltyroutes);
