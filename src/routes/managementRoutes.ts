...
router.get("/board-directors", authenticate, requireClient, tenantIsolation, managementController.getBoardDirectors)
router.put(
  "/board-directors/:id",
  authenticate,
  requireClient,
...
router.get("/senior-management", authenticate, requireClient, tenantIsolation, managementController.getSeniorManagement)
router.put(
