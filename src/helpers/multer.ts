...
// Enhanced error handling middleware with more detailed error messages
...
// Specific configurations for different use cases (maintained for backward compatibility)
...
export const uploadShareholderDocument = upload.fields([
  ...
  { name: "organizationLogo", maxCount: 1 },// Single document upload
]) // Updated maxCount to match new limit
export const uploadFields = upload.fields([
  ...
  { name: "physicalEvidence", maxCount: 1 }
