...
export class LoanWorkflowService {
  ...
  async advanceWorkflow(
    ...
    try {
      ...
      // Verify reviewer is current assignee
      if (workflow.currentAssigneeId !== reviewerId) {
        return {
          success: false,
          message: "You are not the current assignee for this loan"
        };
      }
   ...
   * This method now fetches user data from the database instead of using stored strings
   */
